...
DECLARE
	...
	begin	
                ...
                select id into xIDDoc from cliente_insert;

                insert into doc_compartir (tipo_share,id_share,id_doc) 
                values('clientes',xIDUsuario,xIDDoc);
...
DECLARE
	...
	begin	
                ...
                insert into carpeta(nombre,id_usuario,tipo_usuario,origen) values (xNombre,xIdUsuario,'clientes','external');
...
DECLARE
	...
	begin	
                ...
                insert into carpeta(nombre,id_usuario,tipo_usuario,origen) values (xNombre,xIdUsuario,'employee','external');
...
--
-- Relación de documentos que pueden existir
--
-- POR DEFECTO ORIGEN SYSTEM
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Nominas');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Seguridad Social');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Liquidaciones de IVA');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Liquidaciones de IRPF');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Liquidaciones Sociedades');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Declaraciones censales');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Libros de ventas');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Libros de compras y gastos');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Diario Contable');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Sumas y Saldos');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Balances');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Perdidas y Ganancias');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Ingresos y Gastos');
INSERT INTO carpeta (ID_USUARIO,tipo_usuario, nombre) 
    values (1, 'employee', 'Memoria Anual');


--
-- Guardar el sello de tiempo de una factura
--

CREATE OR REPLACE FUNCTION SaveSelloTiempoFactura(
	xIDFact  integer, SELLO BYTEA
	)  returns void
...
DECLARE
	...
	begin	
               ...
               -- Buscar su doc_world
               SELECT ID INTO xID FROM doc_world WHERE tabla_proceso_name='doc_supporting' 
                    AND id_tabla_proceso = xIDFact;

               -- si existe el documento añadimos el sello de tiempo
               if xID > 0 then

                INSERT INTO firmas_doc_world (id_doc_world,formato_firma,sello_tiempo) 
                VALUES (xID, '', sello);
